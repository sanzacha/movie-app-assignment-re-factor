...
eval("module.exports = function colHTML(html) {\n  return `\n    <div class=\"col\">${html}</div>\n  `;\n};\n\n//# sourceURL=webpack:///./src/col.js?");
...
eval("module.exports = function createHTMLElement(html) {\n  const t = document.createElement('template');\n\n  t.innerHTML = html;\n\n  return t.content.firstElementChild;\n};\n\n\n//# sourceURL=webpack:///./src/createHTMLElement.js?");
...
eval("const createHTMLElement = __webpack_require__(/*! ./createHTMLElement */ \"./src/createHTMLElement.js\");\nconst cardHTML = __webpack_require__(/*! ./card */ \"./src/card.js\");\nconst rowHTML = __webpack_require__(/*! ./row */ \"./src/row.js\");\nconst colHTML = __webpack_require__(/*! ./col */ \"./src/col.js\");\nconst containerHTML = __webpack_require__(/*! ./container */ \"./src/container.js\");\n\nconst compose = (...fns) =>\n  fns.reduceRight((prevFn, nextFn) =>\n    (...args) => nextFn(prevFn(...args)),\n    value => value\n  );\n\nconst gallery = compose(createHTMLElement, containerHTML, rowHTML, colHTML, cardHTML);\n\nmodule.exports = gallery;\n\n\n//# sourceURL=webpack:///./src/gallery.js?");
...
eval("const searchTermChanged = __webpack_require__(/*! ./searchTermChanged */ \"./src/searchApp/searchTermChanged.js\");\nconst startSearch = __webpack_require__(/*! ./startSearch */ \"./src/searchApp/startSearch.js\");\nconst searchComplete = __webpack_require__(/*! ./searchComplete */ \"./src/searchApp/searchComplete.js\");\n\nmodule.exports = (currState = {}, action) => {\n  switch(action.type) {\n    case 'SEARCH_TERM_CHANGED':\n      return searchTermChanged(currState, action);\n    case 'START_SEARCH':\n      return startSearch(currState, action);\n    case 'SEARCH_COMPLETE':\n      return searchComplete(currState, action);\n    default:\n      return currState;\n  }\n};\n\n\n//# sourceURL=webpack:///./src/searchApp/index.js?");

/***/ }),

/***/ "./src/searchApp/searchComplete.js":
/*!*****************************************!*\
  !*** ./src/searchApp/searchComplete.js ***!
  \*****************************************/
/*! no static exports found */
...
eval("module.exports = (currState, action) => {\n  if(action.type !== 'SEARCH_COMPLETE') return currState;\n\n  const searching = false;\n  const {searchResults} = action;\n  return {...currState, searching, searchResults};\n}\n\n\n//# sourceURL=webpack:///./src/searchApp/searchComplete.js?");

/***/ }),

/***/ "./src/searchApp/searchTermChanged.js":
/*!********************************************!*\
  !*** ./src/searchApp/searchTermChanged.js ***!
  \********************************************/
/*! no static exports found */
...
eval("module.exports = (currState = {}, action) => {\n  return action.type === 'SEARCH_TERM_CHANGED'\n  ? {...currState, searchTerm: action.searchTerm} \n  : currState;\n};\n\n//{...currState, searchTerm: action.searchTerm}\n\n//# sourceURL=webpack:///./src/searchApp/searchTermChanged.js?");

/***/ }),

/***/ "./src/searchApp/startSearch.js":
/*!**************************************!*\
  !*** ./src/searchApp/startSearch.js ***!
  \**************************************/
/*! no static exports found */
